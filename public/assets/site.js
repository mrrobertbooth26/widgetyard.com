...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (headerHost) headerHost.outerHTML = `<header class="site-header"><div class="shell header-inner"><a class="brand" href="/" aria-label="WidgetYard home"><img src="/assets/logo.svg" alt="WidgetYard" width="230" height="46"></a><button class="menu-button" type="button" aria-expanded="false" aria-controls="site-nav">Menu</button><nav class="site-nav" id="site-nav" aria-label="Primary"><a href="/">Tools</a><a href="/about/">About</a><a class="nav-cta" href="/?q=">Find a tool</a></nav></div></header>`;
  if (footerHost) footerHost.outerHTML = `<footer class="site-footer"><div class="shell footer-grid"><a class="brand footer-brand" href="/"><img src="/assets/logo-light.svg" alt="WidgetYard" width="230" height="46"></a><p>The tools you need. Right when you need them.</p><nav aria-label="Footer"><a href="/about/">About</a><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a></nav><p class="copyright">© <span data-year></span> WidgetYard</p></div></footer>`;
